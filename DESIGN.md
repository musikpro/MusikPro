...
## Référence MusikPro pour les prochaines pages

Lire [DESIGN-SYSTEM.md](./DESIGN-SYSTEM.md) avant toute nouvelle page ou intégration Banani. Ce document détaille les couleurs, DM Sans, tailles/interlignages, opacités, dégradés, espacements, rayons, ombres, composants et variantes mobile/bureau extraits des deux dashboards. Le catalogue structuré est [design-tokens.json](./design/banani/design-tokens.json).
