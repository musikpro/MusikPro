...
export const displayName = "Profil Utilisateur";
...
export default function UserProfileScreen() {
  ...
  return (
    <div className="bg-background flex flex-col">
      ...
      {/* Content */}
      <div className="workspace-profile-grid flex-1 px-4 pb-6 overflow-y-auto space-y-3">
        {/* Plan Section */}
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full bg-card border border-border rounded-xl px-4 py-3 flex items-center justify-between"
          >
        ...
        <button
          ...
          className="w-full bg-card border border-border/50 rounded-xl px-4 py-3 flex items-center justify-center gap-2 text-destructive mt-4"
        >
