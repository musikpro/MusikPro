...
else if (chromeHint === false)
  console.log("- Chrome local: non détecté dans les emplacements macOS standards (indice seulement)");
...
console.log(
  "2. Demander au Browser Subagent d\'ouvrir https://www.antigravity.google/docs/browser et d\'en lire le titre.",
);
