...
const requiredFiles = [
  ...
  ".agents/skills/setup-saas/SKILL.md", ".agents/skills/security-saas/SKILL.md", "docs/setup-saas.md", ".agents/skills/computer-use/SKILL.md", "docs/computer-use/antigravity-browser.md", "scripts/computer-use-check.mjs", "scripts/computer-use-mark.mjs",
...
if (exists("package.json")) {
  ...
  const expectedScripts = [
    ...
    "lint", "format:check", "test", "audit:prod", "routes:list", "runtime:check", "features:list", "features:check", "smoke:system", "cron:generate", "computer-use:check", "computer-use:mark", "banani:prepare", "banani:check", "import-banani:check", "import-banani:analyze", "clients:crud:setup", "clients:crud:generate", "clients:crud:migrate", "clients:crud:check"
  ];
